...
class ColorPalette {
  ...
  Color get yellowF7A20 =>_isLightTheme ? const Color(0x33F7AA05):const Color(0xFF1A1D2E);
  ...
  Color get walletColor => _isLightTheme ? const Color(0xFF032D4B) : const Color(0xFF979797);

  Color get adButtonColor => _isLightTheme ? const Color(0xFFF7AA05) : const Color(0xFF151925);

  Color get videoPlayColor => _isLightTheme ? const Color(0xFF032D4B) : const Color(0xFFF7AA05);

  Color get walletIcon => _isLightTheme ? const Color(0xFFF7AA05) : white;

  Color get walletButton => _isLightTheme ? const Color(0xFF032D4B) : const Color(0xFF151925);
  ...
  Color get viewersPredictions => _isLightTheme ? const Color(0xFF032D4B): const Color(0xFF1A1D2E);
  Color get selectedPrediction => _isLightTheme ? const Color(0xFF032D4B): const Color(0xFF0D1019);
  Color get unSelectedPredText => _isLightTheme ? black: white;
