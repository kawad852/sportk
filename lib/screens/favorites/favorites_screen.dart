    ...
    return CustomFutureBuilder(
      ...
      onComplete: (context, snapshot) {
        return Scaffold(
          ...
          bottomNavigationBar: !_authProvider.isAuthenticated
              ? BottomAppBar(
                  child: Center(
                ...
                children: [
                  Material(
                    child: Column(
                      children: [
                        VexPaginator(
                          query: (pageKey) async => _favoriteProvider.fetchFavs(context),
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return TeamBubble(
                                    team: team,
                                    onTap: () async {
                                      final result = await _favoriteProvider.toggleFavorites(id, CompoTypeEnum.teams, team.name!);
