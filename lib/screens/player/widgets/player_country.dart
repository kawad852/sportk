...
class PlayerCountry extends StatefulWidget {
  const PlayerCountry({super.key, required this.countryId, required this.jerseyNumber});
  final int countryId;
...
class _PlayerCountryState extends State<PlayerCountry> {
  ...
  void _initializeFuture() {
    _countryFuture = _footBallProvider.fetchCountry(countryId: widget.countryId);
  }
